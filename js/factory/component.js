(function(opspark, createjs, draw, _) {
  ...
  // LAYOUT //
  function render(children, content, padding, direction) {
    let distance = 0;
    switch (direction) {
      case HORIZONTAL:
  ...
  function layout({ children, direction = 'HORIZONTAL', padding = 10, background, area }) {
    const
    ...
    // render first time //
    render(children, content, padding, direction);
  ...
  _.assign(layout, { HORIZONTAL, VERTICAL, GRID });
